...
function fullNameArgsToObject(...strings){
  var names = {};
  for (let i=0; i < strings.length; i++)
  {
    names[strings[i].split(" ")[0].trim()]= strings[i].split(" ")[1].trim();
  }
  return names
}
...
/*
let fullNameArgsToObject = function(...strings){
  var names = {};
  for (let i=0; i < strings.length; i++)
  {
    names[strings[i].split(" ")[0].trim()]= strings[i].split(" ")[1].trim();
...
/*
const fullNameArgsToObject = (...strings) => {
  var names = {};
  for (let i=0; i < strings.length; i++)
  {
    names[strings[i].split(" ")[0].trim()]=strings[i].split(" ")[1].trim();
...
/*
const createNameObject = (name) => objname = {

...
def metodo5(num1,num2,num3,num4)
  num = (num1 * num2) - (num3 / num2) + num1
end

def metodo6(num1,num2,num3,num4)
  num = (num1 * num2) - (num4 / num1) + num3
end
#driver code
...
def metodo8(num1, num2)
  num = num1*(num1*5 + num2*3) - (num1 - num2)
end
...
def metodo9(num1, num2, num3)
  num = (num3.to_f / num2 * num1 * num1).floor
  return num
end

def metodo10(num1, num2, num3)
  num = (num3.to_f / num2 * num1).floor
  return num
end
#driver code

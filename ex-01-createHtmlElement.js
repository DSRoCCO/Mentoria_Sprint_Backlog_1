...
function createHtmlElement(htmlObj){
  return '<'+htmlObj.element+' class=\"'+htmlObj.classNames+'\">'+htmlObj.textContent+'</'+htmlObj.element+'>'
}

// write the function here (: function expression standard

/*
let createHtmlElement = function(htmlObj){
  return '<'+htmlObj.element+' class=\"'+htmlObj.classNames+'\">'+htmlObj.textContent+'</'+htmlObj.element+'>'
}
*/
...
/*
const createHtmlElement = (htmlObj) => '<'+htmlObj.element+' class=\"'+htmlObj.classNames+'\">'+htmlObj.textContent+'</'+htmlObj.element+'>';
*/

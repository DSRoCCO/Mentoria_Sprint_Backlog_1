...
function simpOrSamp(arrayString){

    for (i = 0; i< arrayString.length; i++){
        if (arrayString[i].length < 6){
            arrayString[i] = arrayString[i]+ " Sampson";
        }
        else{
            arrayString[i] = arrayString[i]+ " Simpson";
        }
...
console.log("==== ex-05-simpOrSamp : TEST 1 ====");
...
// /*--------------------------------------------------*/
console.log("==== ex-05-simpOrSamp : TEST 2 ====");
...
// //   have '«arrayVal» Sampson' returned in the new array
// /*--------------------------------------------------*/
console.log("==== ex-05-simpOrSamp : TEST 3 ====");
